...
using static Content.Shared.Paper.PaperComponent; // RMC14
...
using Robust.Client.UserInterface; // RMC14
using Robust.Client.UserInterface.XAML;
using Robust.Shared.Utility;
using Robust.Client.UserInterface.RichText;
using Content.Client.UserInterface.RichText;
using Robust.Shared.Input;
using Robust.Shared.IoC; // RMC14
...
namespace Content.Client.Paper.UI
{
    ...
    public sealed partial class PaperWindow : BaseWindow
    {
        ...
        private Thickness _originalContentMargin; // RMC14
        ...
        private readonly Type[] _allowedTags = new Type[] {
            ...
            typeof(ItalicTag),
            typeof(MonoTag),
            typeof(FormTagHandler), // RMC14
            typeof(SignatureTagHandler), // RMC14
            typeof(CheckTagHandler), // RMC14
        };

        public event Action<string>? OnSaved;
        public event Action<int>? OnSignatureRequested; // RMC14
        ...
        public void InitVisuals(EntityUid entity, PaperVisualsComponent visuals)
        {
            ...
            // RMC14: Calls PaperContent.Margin and sets to _origianlContent Margin after setting _originalContentMargin, instead of calling first to set directly.
        ...
        protected override void Draw(DrawingHandleScreen handle)
        {
            ...
            if (WrittenTextLabel.TryGetStyleProperty<Font>("font", out var font))
            {
                ...
                FormTagHandler.FontLineHeight = fontLineHeight; // RMC14
                SignatureTagHandler.FontLineHeight = fontLineHeight; // RMC14
                CheckTagHandler.FontLineHeight = fontLineHeight; // RMC14
                // This positions the texture so the font baseline is on the bottom and aligns with texture lines:
                _paperContentTex.ExpandMarginTop = font.GetDescent(UIScale);
                // And this scales the texture (vertically) so that it represents the correct nubmer of text line:
        ...
        /// <summary>
        ///     BaseWindow. Determines how the UI window can be dragged/resized around by grabbing
        ///     anywhere on the page, using mouse position (Like FancyWindow).
        ...
        private void RunOnSaved()
        {
            ...
            SaveButton.Disabled = false; // RMC14
        }
